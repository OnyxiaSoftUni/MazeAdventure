   ...
   public class World
    {
        ...
        public const int ITEM_ID_MAZE_PASS = 10;
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new Item(ITEM_ID_MAZE_PASS, "Adventurer pass", "Adventurer passes"));
        }
        ...
        private static void PopulateQuests()
        {
            ...
            clearFarmersField.RewardItem = ItemByID(ITEM_ID_MAZE_PASS);
